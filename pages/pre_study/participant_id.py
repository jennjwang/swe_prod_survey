                    ...
                    if progress['pre_study_completed'] and not checklist_completed:
                        ...
                        if next_issue_result['success'] and next_issue_result['issue'] is None:
                            ...
                            try:
                                ...
                                # Check post-exp1 completion first (it should happen before pr-closed surveys)
                                post_exp1_done = False
                                try:
                                ...
                                if has_pending_pr_surveys:
                                    ...
                                    # No pending PR surveys and not all PRs closed yet — go to thank you page
                                    print("DEBUG: No pending PR surveys, not all PRs closed yet, routing to thank you page")
